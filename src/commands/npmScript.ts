...
export default function (context : vscode.ExtensionContext) {
    const command1 = vscode.commands.registerCommand(commandEntitys.runScript , () => {
        let scripts:any = {} 
        ...
        if(scriptNames.length === 0) {
            return vscode.window.showInformationMessage('未找到package.json 或者 package.json 中未提供 script 字段')
        }
        // 创建 Pick 
